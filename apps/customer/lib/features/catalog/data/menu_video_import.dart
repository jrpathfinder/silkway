...
///
/// Намеренно НЕ добавлено в [CatalogRepositoryMock] (совпадающий 1:1 с
/// бэкенд-фолбэком, `CatalogService.fallbackCatalog`) и не подключено ни в
/// один провайдер — просто зафиксированный черновик, который можно достать,
/// когда понадобится.
///
